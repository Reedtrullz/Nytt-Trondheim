...
restic backup "$BACKUP_STAGE/nytt.dump" "$BACKUP_STAGE/uploads.tar.gz" --tag nytt-trondheim
restic forget --tag nytt-trondheim --keep-daily 7 --keep-weekly 5 --keep-monthly 12 --prune
