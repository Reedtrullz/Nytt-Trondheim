...
describe("SpatialAnalyticsDashboard", () => {
  ...
  it("renders spatial summary, unexplained delays and heatmap cells", () => {
    ...
    expect(html).toContain("Beslutningsgrunnlag");
    expect(html).toContain("Målt av DATEX");
    expect(html).toContain("Koblet trafikkhendelse");
    expect(html).toContain("Ingen koblet");
    expect(html).toContain("Flagges fordi reisetid mangler koblet hendelse.");
    expect(html).toContain("Nyhetsforklaring");
    expect(html).toContain("1 teksttreff");
    expect(html).toContain("Nyhet omtaler trafikk, men er ikke romlig koblet til korridoren.");
    expect(html).toContain("Ingen treff");
    expect(html).toContain("Ingen tydelig trafikknyhet forklarer forsinkelsen.");
    expect(html).toContain("Råspor");
    expect(html).toContain("1 telemetrispor");
    expect(html).toContain("Bruk råtelemetri før offentlig publisering.");
