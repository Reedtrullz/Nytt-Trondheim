...
`SSH_PRIVATE_KEY`, `NYTT_REPO_DEPLOY_KEY`, `NYTT_POSTGRES_PASSWORD`, `NYTT_SESSION_SECRET`, `NYTT_GITHUB_CLIENT_ID`, `NYTT_GITHUB_CLIENT_SECRET`, `NYTT_OPENAI_API_KEY`, `NYTT_RESTIC_REPOSITORY`, `NYTT_RESTIC_PASSWORD`, `NYTT_BACKUP_ACCESS_KEY`, and `NYTT_BACKUP_SECRET_KEY`.
