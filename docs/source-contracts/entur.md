...
- Upstream type: Entur real-time vehicle GraphQL, service-alert situation feeds, request-time Journey Planner v3 trip search and request-time Journey Planner v3 departure boards.
